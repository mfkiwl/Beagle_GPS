...
//`define SDR_GPS_BUILD    // DEFh 0x0
`define GPS_ONLY_BUILD    // DEFh 0x1
...
`define SPI_32    // DEFh 0x1
	localparam NUM_CMDS = 25;    // DEFp 0x19
`define DEF_NUM_CMDS
	localparam GPS_CHANS = 12;    // DEFp 0xc
`define DEF_GPS_CHANS
	localparam RX_CHANS = 0;    // DEFp 0x0
//`define DEF_RX_CHANS
	localparam WF_CHANS = 0;    // DEFp 0x0
//`define DEF_WF_CHANS
...
`define DEF_NRX_SAMPS_RPT
	localparam NRX_SAMPS_LOOP = 0;    // DEFp 0x0
